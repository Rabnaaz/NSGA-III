...
from selection import selection, compare
...
def comp_by_cv_then_random(pop, P, **kwargs):
    ...
    for i in range(P.shape[0]):
        ...
        if pop[a].CV > 0.0 or pop[b].CV > 0.0:
            S[i] = compare(a, pop[a].CV, b, pop[b].CV, return_random_if_equal=True)
...
class NSGA3(GeneticAlgorithm):
    ...
    def __init__(self,
                 ...
                 selection=selection(func_comp=comp_by_cv_then_random),
                 crossover=recombination(eta=30, prob=1.0),
